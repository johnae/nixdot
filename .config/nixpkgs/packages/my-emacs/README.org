...
(use-package ivy
  ...
  (add-hook 'eshell-mode-hook '(lambda ()
    (define-key eshell-mode-map "\t" 'completion-at-point)))
...
(with-eval-after-load 'em-term
  (dolist (p '("fzf" "spook" "git" "home" "htop" "mpsyt" "mpv" "mutt" "ncdu" "newsbeuter" "pinentry-curses"))
