...
Mu + Mu4e = email :-). (This is added to the load path as it comes with mu).
...
(use-package mu4e-alert
    ...
    (setq mu4e-alert-interesting-mail-query
      (concat
       ...
       " AND NOT flag:list"
       " AND NOT maildir:\"/karma-gmail/[Gmail]/All Mail\""
       " AND NOT maildir:\"/insane-gmail/[Gmail]/All Mail\""))
)
#+END_SRC
...
(setq mu4e-bookmarks
  `( ,(make-mu4e-bookmark
     ...
     ,(make-mu4e-bookmark
       ...
       :query "date:today..now AND (\"maildir:/insane-gmail/inbox\" OR \"maildir:/karma-gmail/inbox\")"
       :key ?t)
     ,(make-mu4e-bookmark
       :name "Today's mail"
       :query "date:today..now AND (\"maildir:/insane-gmail/inbox\" OR \"maildir:/karma-gmail/inbox\") AND NOT flag:list"
       :key ?m)
     ,(make-mu4e-bookmark
       :name "Last 7 days"
       :query "date:7d..now AND (\"maildir:/insane-gmail/inbox\" OR \"maildir:/karma-gmail/inbox\")"
       :key ?w)
     ,(make-mu4e-bookmark
